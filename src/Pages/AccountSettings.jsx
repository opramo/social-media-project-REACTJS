  ...
  return (
    <>
      ...
      <div className="min-h-screen flex pt-20 bg-putih justify-center ">
        <div className="w-[600px] flex items-center shadow-lg rounded-2xl  my-5 shadow-black bg-putih py-5">
          <div className="w-full flex flex-col justify-center items-center bg-putih z-10">
