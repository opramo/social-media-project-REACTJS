                              ...
                              <ul>
                                {ingredients.map((ingredient, index) => {
                                  return (
                                    <li
                                      key={index}
                                      className="w-full flex flex-wrap items-center mb-2"
                                    >
                                      <Field
                              ...
                              <ul>
                                {instructions.map((ingredient, index) => {
                                  ...
                                  return (
                                    <li
                                      key={index}
                                      className="w-full min-h-min flex flex-wrap items-center relative mb-3"
                                    >
                                      ...
                                      <Field
                                        ...
                                        className={` ${
                                          ...
                                          formik.touched.recipeName
                                            ? "outline-merah"
                                            : "outline outline-1 outline-gray-500 focus:outline-2 focus:outline-biru"
                                        } p-2 h-full w-[80%] rounded bg-putih`}
                                      />
                                      <div className="w-[10%] flex gap-2 justify-center items-center">
                                        <button
                                          type="button"
